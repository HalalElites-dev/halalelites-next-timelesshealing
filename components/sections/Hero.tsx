            ...
            <div className='relative max-w-8xl mx-auto'>
                <div className='gap-12 flex justify-center'>
                    <div className='text-center'>
                        ...
                        <p className='text-xl md:text-2xl mb-8 max-w-3xl text-muted-foreground m-auto font-hea'>{HERO_SUBTEXT}</p>
                        <div className=' flex flex-col sm:flex-row gap-4 md:justify-center'>
                            <Button size={'lg'} className='bg-primary hover:text-primary-foreground text-secondary md:text-xl md:py-6 font-bold font-heading' >
                                <Link href={HERO_CTA_LINK}>{HERO_CTA_TEXT}</Link>
                            </Button>
                            <Button variant='outline' size={'lg'} className='bg-secondary text-primary hover:text-secondary-foreground md:text-xl md:py-6 font-bold font-heading'>
